        ...
        <div className={styles.container}>
            <Card direction="column" elevation="none" alignContent="center" pad='small' height='medium' width='medium' className={styles.card}>
                ...
                <CardBody className={styles.body} align="center">
                    ...
                    <Text weight='bold' margin='small'>Reception to Follow at Green Gables Restaraunt. 7712 Somerset Pk. Jennerstown, PA 15547. Cocktail Hour starting at 4 p.m.</Text>
                </CardBody>
            </Card>
        </div>
    );
