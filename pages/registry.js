    ...
    return (
        <div className={styles.container}>
            <Box direction='row-responsive'>
                ...
                <Box height='medium' border={{ color: 'black', size: 'medium', style: 'double', side: 'all'}} width='large' basis='1/2' justify='center' alignSelf='center' alignContent='center' round='medium' className={styles.registry}  pad='medium' >
